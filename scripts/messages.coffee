...
module.exports = (robot) ->
  ...
  robot.hear /!guest/gim, (res) ->
    send_aramark_guests_style1("http://aramarkcafe.com/layouts/canary_2015/locationhome.aspx?locationid=3747&pageid=20&stationID=1938", "Plaza 1: \n", res)
    ...
    send_aramark_guests_style2("http://www.aramarkcafe.com/layouts/canary_2015/locationhome.aspx?locationid=3971&pageid=20&stationID=1938", "10 West: \n", res)
